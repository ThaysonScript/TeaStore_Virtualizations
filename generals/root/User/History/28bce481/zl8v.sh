...
export "$CATALINA_HOME/tomcat-registry"
export "$CATALINA_HOME/tomcat-webui"
export "$CATALINA_HOME/tomcat-persistence"
export "$CATALINA_HOME/tomcat-image"
export "$CATALINA_HOME/tomcat-auth"
export "$CATALINA_HOME/tomcat-recommender"
